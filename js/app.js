...
// ─── Thinking na Fase 2: REMOVIDO (shell 100; era opt-in dos shells 93–97) ──
// O acesso do dono recusou todas as gramáticas ("compiled grammar is too large");
// o recurso foi aposentado a pedido dele. Limpeza da preferência antiga:
try{localStorage.removeItem('meridian_f2_think');}catch(e){}
