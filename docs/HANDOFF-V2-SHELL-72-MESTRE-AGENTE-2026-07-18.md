...
| 24 | Pacote de venda do motor (Skill/Input/Output/handover) | **FEITO** 102·motor (`motor/engine.mjs` + `motor/SKILL.md` + `tests/motor.mjs`). Aberto: recorte comercial do handoff p/ comprador |
