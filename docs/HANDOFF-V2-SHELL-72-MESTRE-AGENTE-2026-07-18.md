...
30. Fase 2 enriquecida usa **prefill `{`** (assistant) — JSON garantido por construção. Prefill SÓ sem tools e com thinking off/disabled; ao mexer na Fase 2, preservar o `'{'+text` no parse (shell 77).  
