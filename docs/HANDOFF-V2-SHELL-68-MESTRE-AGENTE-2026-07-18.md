# HANDOFF MESTRE — Meridian v2 · Agente e produto (shell 68)

**Data:** 2026-07-18  
**Branch:** `main` · **Repo:** https://github.com/mzzei/Meridian-v2  
**SHELL_VERSION:** `68` (`js/version.js` = `sw.js` = `index.html ?v=` ×2)  
**HEAD no momento deste documento:** ver `git log -1` (inclui `93e486e` shell 68; `40925f3` fix Worker/Anthropic Origin)
